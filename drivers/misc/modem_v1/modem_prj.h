...
/* Debugging features */
#define MIF_LOG_DIR		"/opt/usr/etc/modem/err/crash"
...
#define MODEM_SLEEP_IDX_MAX				10

#define MODEM_SLEEP_MON_LENGTH			0xFFFF
#define MODEM_SLEEP_MON_SHIFT			16

struct modem_sleep_mon {
	struct net_device *ndev;
...
extern struct modem_sleep_mon modem_smon[MODEM_SLEEP_IDX_MAX];
extern unsigned int modem_mon_idx;
#endif
