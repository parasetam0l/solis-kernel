...
extern void bbd_exit(void);

extern int bbd_on_read_buf_cnt(unsigned int minor);
extern int bcm_spi_rw_buf_cnt(int rw);
extern void get_bcm_irq_time_last(unsigned long long *sec,
		unsigned long *nanosec);
extern void ssp_pkt_dump(const void *buf, const char __user *ubuf, size_t size);
extern void print_ssp_pkt_dump(const char *dp_name);
