...
static struct fimc_is_reg vra_chain0_regs[VRA_CHAIN0_REG_CNT] = {
...
#define VRA_CHAIN0_REG_FIELD_CNT 4
...
static struct fimc_is_field vra_chain0_fields[VRA_CHAIN0_REG_FIELD_CNT] = {
...
static struct fimc_is_reg vra_chain1_regs[VRA_CHAIN1_REG_CNT] = {
...
#define VRA_CHAIN1_REG_FIELD_CNT 5
...
static struct fimc_is_field vra_chain1_fields[VRA_CHAIN1_REG_FIELD_CNT] = {
	/* 1. field_name 2. bit start 3. bit width 4. access type 5. reset */
