...
static int sensor_module_4e6_power_setpin(struct platform_device *pdev,
		struct exynos_platform_fimc_is_module *pdata)
{
	...
	/* Companion */
	SET_PIN_VOLTAGE(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_STANDBY_OFF_COMPANION, gpio_none, "VDDD_RET_1.0V_COMP", PIN_REGULATOR, 1, 100, 1000000);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_STANDBY_OFF_COMPANION, gpio_none, "VDDD_CORE_0.8V_COMP", PIN_REGULATOR, 1, 100);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_STANDBY_OFF_COMPANION, gpio_none, "VDDD_NORET_0.9V_COMP", PIN_REGULATOR, 1, 100);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_STANDBY_OFF_COMPANION, gpio_none, "VDDD_CORE_1.0V_COMP", PIN_REGULATOR, 1, 100);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_STANDBY_OFF_COMPANION, gpio_none, "VDDA_1.8V_COMP", PIN_REGULATOR, 1, 100);
	/* MCLK & reset */
	...
	SET_PIN_VOLTAGE(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_STANDBY_OFF, gpio_none, "VDDD_RET_1.0V_COMP", PIN_REGULATOR, 1, 100, 1000000);
...
int sensor_module_4e6_probe(struct platform_device *pdev)
{
	...
	fimc_is_sensor_module_parse_dt(pdev, sensor_module_4e6_power_setpin);
...
static struct platform_driver sensor_module_4e6_driver = {
	...
	.driver = {
		...
		.owner  = THIS_MODULE,
		.of_match_table = exynos_fimc_is_sensor_module_4e6_match,
	}
};
