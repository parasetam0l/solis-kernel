...
#include "fimc-is-cis-3m2-setA.h"
#include "fimc-is-cis-3m2-setB.h"
...
int sensor_3m2_cis_stream_on(struct v4l2_subdev *subdev)
{
	...
	sensor_3m2_cis_group_param_hold_func(subdev, 0x00);
...
int cis_3m2_probe(struct i2c_client *client,
...
static int cis_3m2_remove(struct i2c_client *client)
{
	int ret = 0;
	return ret;
}

static const struct of_device_id exynos_fimc_is_cis_3m2_match[] = {
	{
		.compatible = "samsung,exynos5-fimc-is-cis-3m2",
	},
	{},
};
MODULE_DEVICE_TABLE(of, exynos_fimc_is_cis_3m2_match);

static const struct i2c_device_id cis_3m2_idt[] = {
	{ SENSOR_NAME, 0 },
};

static struct i2c_driver cis_3m2_driver = {
	.driver = {
		.name	= SENSOR_NAME,
		.owner	= THIS_MODULE,
		.of_match_table = exynos_fimc_is_cis_3m2_match
	},
	.probe	= cis_3m2_probe,
	.remove	= cis_3m2_remove,
	.id_table = cis_3m2_idt
};
module_i2c_driver(cis_3m2_driver);
