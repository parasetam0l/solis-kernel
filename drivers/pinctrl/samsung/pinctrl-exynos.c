				...
				struct samsung_pin_bank *bank)
{
	...
	for (type = 0; type < PINCFG_TYPE_NUM; type++)
		if (widths[type])
			pr_debug("%s: save offs: %#04x, val: %#010x\n",
					bank->name, offs[type], readl(regs + offs[type]));
}
...
static struct samsung_pin_bank exynos7570_pin_banks0[] = {
	EXYNOS_PIN_BANK_EINTW(bank_type_5, 7, 0x000, "etc0", 0x00),
	EXYNOS_PIN_BANK_EINTW(bank_type_5, 3, 0x020, "etc1", 0x00),
	EXYNOS_PIN_BANK_EINTW(bank_type_5, 8, 0x040, "gpa0", 0x00),
	EXYNOS_PIN_BANK_EINTW(bank_type_5, 8, 0x060, "gpa1", 0x04),
	EXYNOS_PIN_BANK_EINTW(bank_type_5, 8, 0x080, "gpa2", 0x08),
	EXYNOS_PIN_BANK_EINTW(bank_type_5, 1, 0x0a0, "gpq0", 0x00),
};

/* pin banks of exynos7570 pin-controller 1 (DISPAUD) */
static struct samsung_pin_bank exynos7570_pin_banks1[] = {
	EXYNOS_PIN_BANK_EINTG(bank_type_4, 7, 0x000, "gpz1", 0x00),
};

/* pin banks of exynos7570 pin-controller 2 (EsE) */
static struct samsung_pin_bank exynos7570_pin_banks2[] = {
	EXYNOS_PIN_BANK_EINTG(bank_type_4, 5, 0x000, "gpc7", 0x00),
};

/* pin banks of exynos7570 pin-controller 3 (FSYS) */
static struct samsung_pin_bank exynos7570_pin_banks3[] = {
         EXYNOS_PIN_BANK_EINTG(bank_type_4, 3, 0x000, "gpr0", 0x00),
         EXYNOS_PIN_BANK_EINTG(bank_type_4, 8, 0x020, "gpr1", 0x04),
         EXYNOS_PIN_BANK_EINTG(bank_type_4, 6, 0x040, "gpr4", 0x08),
};

/* pin banks of exynos7570 pin-controller 4 (MIF) */
static struct samsung_pin_bank exynos7570_pin_banks4[] = {
	EXYNOS_PIN_BANK_EINTG(bank_type_4, 1, 0x000, "gpm0", 0x00),
};

/* pin banks of exynos7570 pin-controller 5 (NFC) */
static struct samsung_pin_bank exynos7570_pin_banks5[] = {
	EXYNOS_PIN_BANK_EINTG(bank_type_4, 4, 0x000, "gpc2", 0x00),
};

/* pin banks of exynos7570 pin-controller 6 (TOP) */
static struct samsung_pin_bank exynos7570_pin_banks6[] = {
	EXYNOS_PIN_BANK_EINTG(bank_type_4, 3, 0x000, "gpc0", 0x00),
	EXYNOS_PIN_BANK_EINTG(bank_type_4, 4, 0x020, "gpc1", 0x04),
	EXYNOS_PIN_BANK_EINTG(bank_type_4, 4, 0x040, "gpc4", 0x08),
	EXYNOS_PIN_BANK_EINTG(bank_type_4, 7, 0x060, "gpd1", 0x0c),
	EXYNOS_PIN_BANK_EINTG(bank_type_4, 3, 0x080, "gpe0", 0x10),
	EXYNOS_PIN_BANK_EINTG(bank_type_4, 4, 0x0a0, "gpf0", 0x14),
	EXYNOS_PIN_BANK_EINTG(bank_type_4, 2, 0x0c0, "gpf1", 0x18),
	EXYNOS_PIN_BANK_EINTG(bank_type_4, 4, 0x0e0, "gpf3", 0x1c),
};

/* pin banks of exynos7570 pin-controller 7 (TOUCH) */
static struct samsung_pin_bank exynos7570_pin_banks7[] = {
	EXYNOS_PIN_BANK_EINTG(bank_type_4, 3, 0x000, "gpc3", 0x00),
	EXYNOS_PIN_BANK_EINTG(bank_type_4, 1, 0x020, "gpd2", 0x04),
};

struct samsung_pin_ctrl exynos7570_pin_ctrl[] = {
	{
		/* pin-controller instance 0 Alive data */
...
int exynos7570_secgpio_get_nr_gpio(void)
{
	...
	/*
	 * There are no gpc0-0, gpc1-0, gpc1-1 and gpe0-1
	 * Be careful to check the gpio configurations
	 */
	return nr_gpio - 4;
}
#endif
...
{
	/* 10 offset caused by etc0(7), etc1(3) */
	return exynos7570_pin_ctrl[0].base + 10 + eint;
}
#endif
