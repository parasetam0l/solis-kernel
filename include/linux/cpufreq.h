...
#elif defined(CONFIG_CPU_FREQ_GOV_TIZEN_JAVAW)
extern struct cpufreq_governor cpufreq_gov_tizen_javaw;
#define CPUFREQ_DEFAULT_GOVERNOR    (&cpufreq_gov_tizen_javaw)
#endif
