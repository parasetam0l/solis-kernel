...
#define DEFAULT_VRECT_MID_VOLTAGE_THRESHOLD 4200
#define DEFAULT_VRECT_HIGH_VOLTAGE_THRESHOLD 4250

#if defined(CONFIG_P9220_VOUT_CONTROL)
#define P9220_ALIVE_CHECK_INTERVAL_S 3
#endif
...
struct sec_battery_info {
...
#if defined(CONFIG_P9220_VOUT_CONTROL)
	struct alarm p9220_alive_check_alarm;
	struct delayed_work p9220_alive_check_work;
	struct wake_lock p9220_alive_check_lock;
#endif
	...
	int vrect_mid_voltage_threshold;
	int vrect_high_voltage_threshold;

	bool charging_block;
#if defined(CONFIG_BATTERY_SWELLING)
	bool swelling_mode;
	bool swelling_mode_cur;
	bool swelling_partial;
