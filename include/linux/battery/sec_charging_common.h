...
struct sec_battery_platform_data {
	...
	bool swelling_mode_skip_in_high_temp;	/* sustaining event after deactivated (second) */
	...
	int ldu_full_soc;
	int ldu_recharge_soc;

	int wpc_auth_check_time;

#if defined(CONFIG_FORCE_TO_FULL)
	int t_limit_topoff_1st;
	int t_limit_topoff_2nd;
#endif
