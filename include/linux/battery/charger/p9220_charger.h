...
#define P9220_WPC_FLAG_REG					0x80
#define P9220_BATT_VOLTAGE_HEADROOM_L		0x90
#define P9220_BATT_VOLTAGE_HEADROOM_H		0x91
#define P9220_VOUT_LOWER_THRESHOLD			0x92
#define P9220_IDT_BATTERY_MODE				0x96
#define P9220_VRECT_TARGET_VOL_L			0xB0
#define P9220_VRECT_TARGET_VOL_H			0xB1
...
#define P9220_RAW_IOUT_L_REG				0x007A
#define P9220_RAW_IOUT_H_REG				0x007B
...
#define P9220_CMD_SS_WATCHDOG_SHIFT			7
...
#define P9220_CMD_SS_WATCHDOG_MASK			(1 << P9220_CMD_SS_WATCHDOG_SHIFT)
...
#define P9220_CMD_SEND_RX_DATA				P9220_CMD_SEND_RX_DATA_MASK
...
#define P9220_RX_DATA_COM_REQ_TX_ID			0x01
...
/* Flag Register, (0x80) */
#define P9220_WATCHDOG_DIS_SHIFT			5
#define P9220_WATCHDOG_DIS_MASK			(1 << P9220_WATCHDOG_DIS_SHIFT)
#define P9220_VBAT_MONITORING_MODE_SHIFT	7
#define P9220_VBAT_MONITORING_MODE_MASK		(1 << P9220_VBAT_MONITORING_MODE_SHIFT)

#define P9220_VBAT_MONITORING_MODE			P9220_VBAT_MONITORING_MODE_MASK

/* IDT Battery Mode Register(0x96) */
#define P9220_IDT_BATTERY_INITIAL_MODE		0x01
...
#define P9220_OTP_FIRM_VERSION						0x3601
#define P9220_SRAM_FIRM_VERSION						0x04 /* 2015-6-9 */

struct p9220_sec_mode_config_data {
	int vrect;
	int vout;
};
...
struct p9220_charger_platform_data {
	...
	struct p9220_sec_mode_config_data *sec_mode_config_data;
	int num_sec_mode;
...
struct p9220_charger_data {
	...
	struct delayed_work	wpc_lpm_work;
	struct delayed_work wpc_init_work;
	struct delayed_work wpc_init_detect_work;
	struct delayed_work wpc_mode_work;
